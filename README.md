...
## Size
There are 12 variables & there are 1691 observations Format: CSV Source:https://www.kaggle.com/datasets/utkarshx27/smoking-dataset-from-uk?resource=download 

## Analysis 
The tentative analysis plan is as follows:

- Check for the need of data cleaning
- Get familiar with the dataset itself
- Create visualizations to show the distribution of age and smoking to enhance understanding
...
- Compare the results from each approach (includes: interpretation & visualizations) 7. Document findings & results Author Contribution’s: TBD
